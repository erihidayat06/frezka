<template>
  <form @submit="formSubmit">
    ...
    <div class="row">
      <InputField :label="$t('setting_general_page.lbl_app')" :value="app_name" v-model="app_name" :errorMessage="errors.app_name" :isRequired="true" ></InputField>

      <InputField :label="$t('setting_general_page.lbl_footer')" :value="footer_text" v-model="footer_text" :errorMessage="errors.footer_text" :isRequired="true" ></InputField>
      <InputField :label="$t('setting_general_page.lbl_copyright')" :value="copyright_text" v-model="copyright_text" :errorMessage="errors.copyright_text" :isRequired="true" ></InputField>
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_shop_number')" placeholder="" v-model="bussiness_address_line_1"></InputField>
      </div>
      <div class="col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_landmark')" placeholder="" v-model="bussiness_address_line_2"></InputField>
      </div>
      <div class="col-lg-2 col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_country')" placeholder="" v-model="bussiness_address_country"></InputField>
      </div>
      <div class="col-lg-2 col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_state')" placeholder="" v-model="bussiness_address_state"></InputField>
      </div>
      <div class="col-lg-2 col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_city')" placeholder="" v-model="bussiness_address_city"></InputField>
      </div>
      <div class="col-lg-2 col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_postal_code')" placeholder="" v-model="bussiness_address_postal_code"></InputField>
      </div>
      <div class="col-lg-2 col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_lat')" placeholder="" v-model="bussiness_address_latitude"></InputField>
      </div>
      <div class="col-lg-2 col-md-6">
        <InputField :is-required="false" :label="$t('branch.lbl_long')" placeholder="" v-model="bussiness_address_longitude"></InputField>
      </div>
    </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-8">
            <div class="d-flex align-items-center gap-2">
              ...
              <input type="button" class="btn btn-danger mb-5" name="remove" :value="$t('messages.remove')" @click="removeLogo()" v-if="logoViewer" />
            </div>
