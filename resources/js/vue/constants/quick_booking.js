...
export const BRANCH_LIST = ({user_id,employee_id, service_id, start_date_time}) => {return {path: `api/quick-booking/branch-list?user_id=${user_id}&employee_id=${employee_id}&service_id=${service_id}&start_date_time=${start_date_time}`, method: 'GET'}}
...
export const HOLIDAY_SLOT_LIST = ({branch_id, date, service_id, employee_id}) => {return {path: `api/quick-booking/slot-date-list?branch_id=${branch_id}&date=${date}&employee_id=${employee_id}&service_id=${service_id}`, method: 'GET'}}
