                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-1">
                      @if (!isset($global_booking) && !auth()->user()->hasRole('super admin'))
                        ...
                        <a href="javascript:void(0)" class="btn btn-secondary px-md-5 px-3 appointment-create-btn" id="appointment-button"><i class="fa-solid fa-plus"></i> {{ __('messages.appointment') }}</a>
                        @endhasPermission
                        @endif
                      @yield('banner-button')
                    </div>
