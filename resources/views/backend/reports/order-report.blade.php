        ...
        <x-backend.section-header>
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        <div>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control order-code" placeholder="{{ __('messages.order_code') }}" name="code" value="{{ isset($searchCode) ? $searchCode : '' }}">
                            </div>
                        </div>
                        <div>
                            <div class=" input-group gap-2 flex-nowrap">
                                <input type="text" name="order_date" id="order_date" placeholder="{{ __('messages.select_date_range') }}" class="order-report-date-range form-control" readonly />
                ...
                <x-slot name="toolbar">
                    <div class="d-flex flex-wrap gap-3">
                        <div>
                        <button type="button" class="btn btn-secondary" data-modal="export" data-bs-title="{{ __('messages.export') }}" data-bs-toggle="tooltip">
                    ...
                    <div class="input-group flex-nowrap top-input-search">
                        <h5 class="mb-0">{{ __("messages.total_amount") }} : <strong>{{\Currency::format($totalAdminEarnings)}}</strong></h5>
                    </div>
