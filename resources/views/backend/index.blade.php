...
<div class="row">
  ...
  <div class="d-flex justify-content-between align-items-md-center gap-3 flex-md-row flex-column mb-4">
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3">
        <div class="card dashboard-cards appointments" style="background-image: url({{ asset('img/dashboard/services.svg') }})">
          <a href="{{ route('backend.bookings.datatable_view') }}" class="card-body">
            <div class="d-flex align-items-start justify-content-between gap-3 title">
                ...
                <div class="dashboard-icon" data-bs-toggle="tooltip" data-bs-title="{{__('messages.total_appointment_count')}}">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card dashboard-cards services" style="background-image: url({{ asset('img/dashboard/services.svg') }})">
          <div class="card-body">
            <div class="d-flex align-items-start justify-content-between gap-3 title">
              <h3 class="mb-2">{{ $data['total_revenue'] }}</h3>
              <div class="dashboard-icon" data-bs-toggle="tooltip" data-bs-title="{{__('messages.total_revenue')}}">
                <i class="fa-solid fa-circle-info" ></i>
              </div>
            </div>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card dashboard-cards new-customer" style="background-image: url({{ asset('img/dashboard/new-users.svg') }})">
  ...
  <div class="col-xl-4">
    <div class="card">
      <div class="card-body upcoming-appointments {{ count($data['upcomming_appointments']) > 0 ? '' : 'iq-upcomming' }}">
        <div class="d-flex justify-content-between align-items-center flex-md-row flex-coulmn gap-3 mb-4">
          <h4 class="card-title">{{ __('dashboard.lbl_upcoming_appointment') }} </h4>
        ...
        <ul class="list-group list-group-flush ">
          ...
          <li class="list-group-item">
            <div class="d-flex justify-content-between align-items-center flex-md-nowrap flex-wrap gap-3">
