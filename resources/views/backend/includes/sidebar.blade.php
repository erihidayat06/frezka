...
<div class="sidebar-base pr-hide
    ...
    <div class="d-flex align-items-center justify-content-start">
        <div class="logo-main">
            ...
            <img class="logo-normal img-fluid" src="{{ asset(setting('logo') ?? 'images/logo/frezka.png') }}" height="30" alt="{{ app_name() }}">
                <img class="logo-normal dark-normal img-fluid" src="{{asset(setting('dark_logo') ?? '/images/logo/dark_logo.png')}}" height="30" alt="{{ app_name() }}">
                <img class="logo-mini img-fluid" src="{{asset(setting('mini_logo') ?? '/images/logo/mini_logo.png')}}" height="30" alt="{{ app_name() }}">
            </a>
        </div>
