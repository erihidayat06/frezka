...
<body>
  <div class="invoice">
    ...
    <div class="invoice-details">
      <p class="invoice-order"><strong>{{__('messages.invoice_no')}}</strong>{{__('messages.ORDER')}}{{$data['id']}}</p>
...
@endforeach
      ...
      <tfoot>
        ...
        <tr>
          ...
          @endif
        <tr>
          <td colspan="3" style="color: #000000; text-align: right;"><strong>{{__('messages.grand_total')}}</strong></td>
