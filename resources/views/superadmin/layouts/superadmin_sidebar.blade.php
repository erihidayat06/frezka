...
<li class="nav-item {{ request()->routeIs('backend.website-setting.index') ? 'active' : '' }}">
    <a target="_self" class="nav-link {{ request()->routeIs('backend.website-setting.index') ? 'active' : '' }}" href="{{ route('backend.website-setting.index') }}">
        <i class="icon fa-solid fa-cogs" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Website Settings" data-bs-original-title="Website Settings"></i><span class="item-name">{{ __('sidebar.website_settings') }}</span><i class="icon"></i>
    </a>
</li>
