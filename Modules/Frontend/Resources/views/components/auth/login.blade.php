    ...
    <section class="login-page">
        <div class="container-fluid px-0 h-100">
            <div class="row align-items-center h-100">
                <div class="col-lg-6"
                    style="background-image: url('{{ asset('/img/frontend/login-pattern.png') }}'); background-repeat: no-repeat; background-size: cover;">
                    <div class="row justify-content-center align-items-center h-100">
                        <div class="col-lg-8">
                            <div class="login-wrapper p-5 p-lg-0">
                                ...
                                @endif
                                <form id="form-submit" method="post" action="{{ route('admin-login') }}"
                                    ...
                                    <div class="form-group mb-4 pb-1">
                                        ...
                                        <div class="input-group  custom-input-group ">
                                            <input type="email" name="email" class="form-control" id="email-id"
                                    ...
                                    <div class="form-group mb-4 pb-1">
                                        ...
                                        <div class="input-group custom-input-group">
                                            <input type="password" name="password" class="form-control" id="password"
                                                placeholder="eg “#123@Abc”" min="8" required />
                                    ...
                                    <div class="mt-5">
                                        <button type="submit" id="login-button"
                                            class="btn btn-secondary w-100">{{ __('messages.login') }}</button>
                                    </div>
                                </form>
                ...
                <div class="col-lg-6 h-100 mt-lg-0 mt-5 d-none d-lg-block"
                    style="background-image: url('{{ asset('/img/frontend/login-banner.jpg') }}'); background-repeat: no-repeat; background-size: cover;">
                </div>
            </div>
        </div>
    </section>
