...
@section('content')
    <section class="register-page" style="background-image: url({{ asset('/img/frontend/register-page-pattern.png') }}); backgound-repat: no-repeat; background-size: cover;" >
                ...
                <div class="col-lg-10">
                    <div class="py-5 px-3">
                        ...
                        <div class="register-bg register-background-padding">
                            ...
                            <form id="form-submit" method="post" action="{{ route('store-data') }}" class="requires-validation" data-toggle="validator" >
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4 pb-1">
                                            <label for="InputFirstName" class="form-label fw-medium">{{__('messages.first_name')}}<span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group  custom-input-group ">
                                                <input type="text" class="form-control"
                                                    id="firstname" placeholder="eg ”Martina”"  value="{{ old('first_name') }}"  name="first_name" required/>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4 pb-1">
                                            <label for="InputLastname" class="form-label fw-medium">{{__('messages.last_name')}}<span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group  custom-input-group ">
                                                <input type="text" name="last_name" class="form-control"
                                                    id="last_name" placeholder="eg ”Abhrahim”" value="{{ old('last_name') }}"  required/>
                                                <span class="input-group-text">
                                                    <i class="ph ph-user"></i>
                                                </span>
                                            </div>
                                            ...
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <div class="invalid-feedback" id="last_name_error">{{('messages.last_name_field_is_required')}}</div>
                                        </div>

                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4 pb-1">
                                            <label for="InputUserName" class="form-label fw-medium">{{__('messages.user_name')}}<span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group  custom-input-group ">
                                                <input type="text" class="form-control"
                                                    id="username" placeholder="eg ”Martina_Abhrahim”"  value="{{ old('username') }}"  name="username" required/>
                                                <span class="input-group-text">
                                                    <i class="ph ph-user"></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="form-group mb-4 pb-1">
                                            ...
                                            <div class="input-group  custom-input-group ">
                                                <input type="email" name="email" class="form-control"
                                                    id="email" placeholder="demo@gmail.com" value="{{ old('email') }}" required/>
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4 pb-1">
                                            <label for="InputPhoneNo" class="form-label fw-medium">{{__('messages.phone_number')}}<span
                                                    class="text-danger">*</span></label>
                                                <div class="input-group custom-input-group mb-3">
                                                    <input type="tel"  name="mobile" class="form-control"
                                                        id="mobile" placeholder="eg “01234 - 5678”" value="{{ old('mobile') }}"
                                            ...
                                            @error('mobile')
                                            <span class="text-danger">{{__('messages.the_phone_number_has_already_been_taken.')}}</span>
                                            @enderror
                                            <div class="invalid-feedback" id="mobile_error">{{__('messages.phone_number_field_is_required')}}</div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4 pb-1">
                                            <label for="InputConfirmPassword" class="form-label">{{__('messages.confirm_password')}}<span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group custom-input-group ">
                                                <input type="password" class="form-control"
                                                    id="password_confirmation" min="8" name="password_confirmation" placeholder="eg “#123@Abc”" required/>
                                            ...
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            <div class="invalid-feedback" id="password_confirmation_error">{{__('messages.confirm_password_field_is_required')}}</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
