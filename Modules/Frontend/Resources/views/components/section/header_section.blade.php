                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('index') }}" class="navbar-brand m-0">
                        <span class="logo-normal">
                            <img src="{{ setting('logo') ? asset(setting('logo')) : asset('/img/frontend/frezka-logo.png') }}" alt="logo" class="img-fluid logo"
                                loading="lazy">
                        </span>
                    </a>
                </div>
                    ...
                    <div class="offcanvas-header pt-3">
                        <a href="./index.html" class="navbar-brand m-0">
                            <span class="logo-normal">
                                <img src="{{ setting('logo') ? asset(setting('logo')) : asset('/img/frontend/frezka-logo.png') }}" alt="logo" class="img-fluid"
                                    loading="lazy">
                            </span>
                        </a>
                    ...
                    <ul class="navbar-nav iq-nav-menu list-unstyled" id="header-menu">
                        ...
                        @if ($features !== null && $features->isNotEmpty())
                            <li class="nav-item">
                                <a href="#features" class="nav-link {{ request()->routeIs('feature') ? 'active' : '' }}" data-bs-toggle="collapse">
                                ...
                                <ul id="features" class="sub-nav mega-menu-item collapse list-unstyled">
                                    <li class="nav-item text-center">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 class="notice-badge">{{__('messages.new_features_are_launching_soon_stay_tune!')}}
                                                </h6>
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="row">
                                                        ...
                                                        @foreach ($featureChunk as $feature)
                                                            <li class="nav-item">
                                                                <a class="nav-link" href="{{ route('feature') }}">
                                                                    <span class="item-name">{{ $feature->title ?? '' }}</span>
                                                                </a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                            ...
                                            @if ($totalFeatures > 9)
                                                <div class="col-12 text-center mt-3">
                                                    <a href="{{ route('feature') }}" class="btn btn-link text-primary">{{__('messages.See_all_features')}}</a>
                                                </div>
                                            @endif
                                        </div>
                                    </li>
                        ...
                        @endauth
                        <li class="nav-item">
                            <a href="#resources" class="nav-link {{ in_array(request()->route()->getName(), ['about_us', 'blogs']) ? 'active' : '' }}" data-bs-toggle="collapse">
                    ...
                    <div class="navbar-collapse collapse" id="headerActionPanel">
                                ...
                                <div class="dropdown dropdown-user-wrapper">
                                    <a class="nav-link dropdown-user" href="#" id="navbarDropdown" role="button"
                                        ...
                                        <img src="{{ asset(user_avatar()) }}"
                                            class="img-fluid user-image rounded-circle" alt="{{ auth()->user()->name ?? default_user_name() }}">
                                    </a>
                                        ...
                                        <div
                                            ...
                                            <div class="d-inline-flex align-items-center gap-3">
                                                <div class="image flex-shrink-0">
                                                    <img src="{{ asset(user_avatar()) }}"
                                                        class="img-fluid dropdown-user-menu-image" alt="{{ auth()->user()->name ?? default_user_name() }}">
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="link">
                                                <a href="{{ route('backend.my-profile') }}" class="link-body-emphasis">
                                                    <i class="ph ph-caret-right"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <ul class="d-flex flex-column gap-3 list-inline m-0 p-0">                                            <li>
                                                <a href="{{ route('app.home') }}" class="link-body-emphasis font-size-14">
                                                    <span
                                                        class="d-flex align-items-center justify-content-between gap-3">
                                                        <span class="fw-medium">{{__('messages.dashboard')}}</span>
                                                        <i class="ph ph-caret-right"></i>
                                                    </span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('edit-profile') }}" class="link-body-emphasis font-size-14">
                                                    <span
                                                        class="d-flex align-items-center justify-content-between gap-3">
                                                        <span class="fw-medium">{{__('messages.profile')}}</span>
                                                        <i class="ph ph-caret-right"></i>
                                                    </span>
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a class="link-primary font-size-14" href="{{ route('logout') }}" id="logout-link" >
                        ...
                        @else
                            <div class="header-btn-wrap d-flex align-items-center gap-3">
                                ...
                                <a href="{{ route('user.login') }}" class="btn btn-primary">{{__('messages.login')}}</a>
                            </div>
                        @endif
                        </div>
                    </div>
