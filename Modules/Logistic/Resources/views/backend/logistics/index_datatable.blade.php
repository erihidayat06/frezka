...
@section('content')
    ...
    <div data-render="app">
        <form-offcanvas default-image="{{default_feature_image()}}" create-title="{{ __('messages.new') }} {{ __('logistics.singular_title') }}"
            edit-title="{{ __('messages.edit') }} {{ __('logistics.singular_title') }}" :customefield="{{ json_encode($customefield) }}">
        </form-offcanvas>
    </div>
