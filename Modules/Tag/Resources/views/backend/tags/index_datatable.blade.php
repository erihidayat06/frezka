...
@section('content')
    ...
    <div data-render="app">
        <form-offcanvas create-title="{{ __('messages.new') }} {{ __('tags.singular_title') }}"
            edit-title="{{ __('messages.edit') }} {{ __('tags.singular_title') }}" :customefield="{{ json_encode($customefield) }}">
        </form-offcanvas>
    </div>
