...
class SlidersController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('slider.title');
        // module name
    ...
    public function index(Request $request)
    {
        ...
        return view('slider::backend.sliders.index_datatable', compact('module_action', 'filter', 'columns','module_title'));
    }
    ...
    public function update(SliderRequest $request, $id)
    {
        ...
        $message = Str::singular($this->module_title).__('messages.update_form');
