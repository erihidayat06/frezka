...
{
    return $this->hasOne(Coupon::class, 'promotion_id', 'id');
}
    ...
    public function promotionCouponPlanMappings()
{
    return $this->hasMany(PromotionsCouponPlanMapping::class, 'coupon_id')->with('plan');
}
