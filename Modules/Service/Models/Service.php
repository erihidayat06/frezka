...
class Service extends BaseModel
{
    ...
    protected $fillable = ['slug', 'name', 'description', 'duration_min', 'default_price', 'category_id', 'sub_category_id', 'status','created_by', 'updated_by'];
    ...
    {
        return $this->hasMany(ServiceEmployee::class, 'service_id', 'id')->with('employee');
    }
