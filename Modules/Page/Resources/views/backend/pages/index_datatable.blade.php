...
@section('content')
            ...
            <x-backend.section-header>
                ...
                <div>
                  <div class="datatable-filter" style="width: 100%; display: inline-block;">
                      {{$filter['status']}}
                    <select name="column_status" id="column_status" class="select2 form-control" style="width: 100%" data-filter="select" >
    ...
    <div data-render="app">
        ...
        <page-offcanvas
            create-title="{{ __('messages.new') }} {{ __('page.singular_title') }}"
            edit-title="{{ __('messages.edit') }} {{ __('page.singular_title') }}">
        </page-offcanvas>

        <x-backend.advance-filter>
          <x-slot name="title"><h4>{{__('messages.advance_filter')}}</h4></x-slot>
...
const columns = [
            ...
            { data: 'sequence', name: 'sequence',  title: "{{ __('page.lbl_sequence') }}" },
