...
@section('content')
    ...
    <div data-render="app">
        <city-form-offcanvas create-title="{{ __('messages.new') }} {{ __('city.singular_title') }}"
            edit-title="{{ __('messages.edit') }} {{ __('city.singular_title') }}">
        </city-form-offcanvas>
    </div>
    ...
    <script type="text/javascript" defer>
        const columns = [{
            ...
            },
            {
                data: 'state_id',
                name: 'state_id',
                title: "{{ __('state.singule_title') }}"
            },
            {
                data: 'country_id',
                name: 'country_id',
                title: "{{ __('country.singular_title') }}",
                searchable: false,
            },
            {
                data: 'status',
