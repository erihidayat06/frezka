  ...
  <form @submit="formSubmit">
    <div class="offcanvas offcanvas-end" tabindex="-1" id="form-offcanvas" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-body">
        <InputField class="col-md-12" :placeholder="$t('state.enter_name')" type="text" :is-required="true" :label="$t('messages.name')" placeholder="" v-model="name" :error-message="errors['name']" :error-messages="errorMessages['name']"></InputField>
        ...
        <div class="col-md-12 form-group">
          ...
          <Multiselect id="units-list" v-model="state_id" :placeholder="$t('state.select_state')" :value="state_id" v-bind="singleSelectOption" :options="state.options" class="form-group"></Multiselect>
...
import { EDIT_URL, STORE_URL, UPDATE_URL, STATE_URL, COUNTRY_URL } from '../constant/city'
...
const getState = (value) => {
  useSelect({ url: STATE_URL, data: value }, { value: 'id', label: 'name' }).then((data) => (state.value = data))
}
const getCountry = () => {
