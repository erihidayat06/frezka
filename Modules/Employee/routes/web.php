...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    Route::get('employees-review', [EmployeesController::class, 'review'])->name('employees.review')->middleware(['auth', 'check.menu.permission']);
    Route::resource('employees', EmployeesController::class)->middleware(['auth', 'check.menu.permission']);
});
