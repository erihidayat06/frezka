        ...
        <div class="row">
          <div class="col-12 row">
            <div class="col-md-8">
              <div class="row">
                ...
                <div class="form-group col-md-6">
                  ...
                  v-bind="{ mode: 'international', maxLen: 15, placeholder:'' }" autocomplete="new-password"  ></vue-tel-input>
            ...
            <div class="col-md-4">
              <div class="text-center upload-image-box">
                ...
                <div class="d-flex align-items-center justify-content-center gap-2">
                  ...
                  <label class="btn btn-sm btn-primary" for="logo">{{ $t('messages.upload') }}</label>
                  <input type="button" class="btn btn-sm btn-secondary" name="remove" value="Remove" @click="removeLogo()"
                    v-if="ImageViewer" />
                </div>
            ...
            <div class="form-group m-0 col-md-4">
              <label class="form-label" for="show-in-calender">
                  {{ $t('employee.lbl_show_in_calender') }}
                </label>
              <div class="form-check form-control px-5">
            ...
            <div class="form-group m-0 col-md-4">
              <label class="form-label" for="is-manager">
            ...
            <div class="form-group col-md-12">
              ...
              <Multiselect id="branch_id" v-model="branch_id" :value="branch_id" :placeholder="$t('messages.select_branch')"
            ...
            <div class="form-group col-md-12">
              ...
              <Multiselect id="service_id" v-model="service_id" :multiple="true" :value="service_id"
                :placeholder="$t('messages.lbl_select_service')" v-bind="multiSelectOption" :options="services.options" class="form-group">
              </Multiselect>
            ...
            <InputField class="col-md-6" :label="$t('employee.lbl_twitter_link')" :placeholder="$t('employee.lbl_twitter_link')" v-model="twitter_link"
...
const validationSchema = yup.object({
    first_name: yup.string()
      ...
      .test('is-string', t('messages.only_strings_allowed'), (value) => {
    ...
    .test('is-string', t('messages.only_strings_allowed'), (value) => !numberRegex
    .test(value))
    ...
    mobile: yup.string()
      .required(t('messages.phone_required')).matches(/^(\+?\d+)?(\s?\d+)*$/, t('messages.phone_invalid')),
    password : yup.string().test('password',t('messages.password_required') , function(value) {
    ...
    confirm_password : yup.string().test('confirm_password', t('messages.confirm_password_required'), function(value) {
      if(currentId === 0 && !value){
        return false;
      }
      return true
    ...
    commission_id: yup.string()
      .required(t('messages.commission_required')),
      branch_id: yup.number()
  .required(t('messages.branch_required'))
  .test('is-valid-branch', t('messages.branch_required'), value => value > 0)  
});
