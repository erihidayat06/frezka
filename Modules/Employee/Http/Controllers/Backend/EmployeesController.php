...
class EmployeesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee::backend.employees.index', compact('module_action', 'columns', 'customefield', 'export_import', 'export_columns', 'export_url','module_title'));
    }
    ...
    public function employee_list(Request $request)
    {
        ...
        $query_data = User::role('employee')->with('media', 'branches','mainBranch')->where(function ($q) use ($term) {
            if (!empty($term)) {
