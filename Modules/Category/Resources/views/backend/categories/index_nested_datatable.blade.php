                ...
                <x-slot name="toolbar">
                  ...
                  <div class="input-group flex-nowrap top-input-search">
                    ...
                    @hasPermission('create_subcategories')
                      <button type="button" class="btn btn-primary align-items-center" data-crud-id="{{0}}"><i class="fas fa-plus-circle me-2"></i>{{ __('messages.new') }}</button>
                    @endhasPermission
                </x-slot>
            </x-backend.section-header>
...
@push('after-scripts')
    ...
    const columns = [
            ...
            { data: 'name', name: 'name',  title: "{{ __('category.lbl_name') }}" ,width: '15%',  orderable: true },
