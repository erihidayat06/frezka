...
class CategoriesController extends Controller
{
    ...
    {
        $module_name = $this->module_name;
        $query = Category::query()->with('media')->whereNull('parent_id')->where('created_by', auth()->id());
    ...
    {
        $categories = Category::with('mainCategory')->whereNull('parent_id')->where('created_by', auth()->id());
