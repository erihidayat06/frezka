...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::get('bookings-table-view', [BookingsController::class, 'datatable_view'])->name('bookings.datatable_view')->middleware(['auth', 'check.menu.permission']);
    Route::resource('bookings', BookingsController::class)->middleware(['auth', 'check.menu.permission']);
});
