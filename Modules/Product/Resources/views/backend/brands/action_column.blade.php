<div class="d-flex gap-2 align-items-center">
    ...
    <a href="{{ route('backend.brands.destroy', $data->id) }}" id="delete-{{ $module_name }}-{{ $data->id }}"
        ...
        data-confirm="{{ __('messages.are_you_sure?', ['module' => __('brand.singular_title'), 'name' => $data->name]) }}">
