...
@section('content')
    ...
    <div data-render="app">
        <brand-form-offcanvas default-image="{{default_feature_image()}}" create-title="{{ __('messages.new') }} {{ __('product.brand') }}"
            edit-title="{{ __('messages.edit') }} {{ __('product.brand') }}" :customefield="{{ json_encode($customefield) }}">
