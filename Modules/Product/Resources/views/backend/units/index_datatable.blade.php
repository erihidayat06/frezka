...
@section('content')
    ...
    <div data-render="app">
        <units-form-offcanvas create-title="{{ __('messages.new') }} {{ __('units.singular_title') }}"
            edit-title="{{ __('messages.edit') }} {{ __('units.singular_title') }}" :customefield="{{ json_encode($customefield) }}">
