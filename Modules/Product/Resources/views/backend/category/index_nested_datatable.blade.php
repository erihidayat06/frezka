...
@section('content')
                ...
                <x-slot name="toolbar">
                  ...
                  <div class="input-group flex-nowrap top-input-search">
                    ...
                    @hasPermission('create_subcategories')
                      <button type="button" class="btn btn-primary align-items-center" data-crud-id="{{0}}" title="{{ __('messages.create') }} {{ __('category.sub_category') }}"><i class="fas fa-plus-circle me-2"></i>{{ __('messages.new') }}</button>
                    @endhasPermission
                </x-slot>
            </x-backend.section-header>
    ...
    <div data-render="app">
        <category-form-offcanvas
            ...
            create-nested-title="{{ __('category.new') }} {{ __('category.sub_category') }} " edit-nested-title="{{ __('messages.edit') }} {{ __('category.sub_category') }}"
