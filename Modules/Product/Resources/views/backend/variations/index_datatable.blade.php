...
@section('content')
    ...
    <div data-render="app">
        <variations-form-offcanvas create-title="{{ __('messages.new') }} {{ __('variations.singular_title') }}"
            edit-title="{{ __('messages.edit') }} {{ __('variations.singular_title') }}" :customefield="{{ json_encode($customefield) }}">
