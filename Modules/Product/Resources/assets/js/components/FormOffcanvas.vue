        ...
        <fieldset>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <Multiselect id="brand-list" v-model="brand_id" :value="brand_id" placeholder="" v-bind="singleSelectOption" :options="brands.options" @select="selectBrand" class="form-group"></Multiselect>
            ...
            <div class="form-group col-md-6">
              ...
              <Multiselect id="categories" v-model="category_ids" :value="category_ids" placeholder="" v-bind="multiselectOption" :options="category.options" class="form-group"></Multiselect>
...
const validationSchema = yup.object({
  ...
  price: yup.string().required(t('messages.price_required')),
  stock: yup.string().required(t('messages.stock_required')),

  category_ids: yup.array().test('category_ids', t('messages.category_required'), function (value) {
    if (value.length == 0) {
      return false
    }
    return true
