        ...
        <div class="card-body">
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                  ...
                  @endcan
                  <button class="btn btn-outline-primary btn-group align-items-center" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><i class="fa-solid fa-filter"></i>  {{__('messages.advance_filter')}}</button>
                </x-slot>
              </x-backend.section-header>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        const columns = [
            ...
            { data: 'id', name: 'id', title: "{{ __('messgaes.id') }}"  },
