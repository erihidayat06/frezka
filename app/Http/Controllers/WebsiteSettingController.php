...
class WebsiteSettingController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = __('messages.website_settings');

        // module name
        $this->module_name = 'website-setting';
    ...
    {
        $module_action = __('messages.website_settings');
        $module_title = __('messages.website_settings');
