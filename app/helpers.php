...
if (!function_exists('setting')) {
    function setting($key, $default = null)
    {
        ...
        $superAdminKeys = ['str_payment_method', 'razor_payment_method', 'paystack_payment_method', 'paypal_payment_method',
                            'flutterwave_payment_method', 'cinet_payment_method', 'sadad_payment_method', 'airtelmoney_payment_method', 'phonepay_payment_method', 'midtrans_payment_method', 'slot_duration' ];
